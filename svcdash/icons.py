...
ICONS = {
    ...
    "user":   '<circle cx="8" cy="5" r="2.7"/><path d="M2.8 13.6c.8-2.7 2.8-4.1 5.2-4.1s4.4 1.4 5.2 4.1"/>',
    "chat":   '<path d="M2.4 3.4h11.2v7.4H6.8L4 13.2v-2.4H2.4Z"/><path d="M5 6h6M5 8.2h3.6"/>',
    "power":  '<path d="M8 2.2v5"/><path d="M4.8 4.4a4.7 4.7 0 1 0 6.4 0"/>',
    "spark":  '<path d="M8 1.8 9.3 6 13.6 7.3 9.3 8.6 8 12.8 6.7 8.6 2.4 7.3 6.7 6Z"/><path d="M12.4 11.4l.5 1.5 1.5.5-1.5.5-.5 1.5-.5-1.5-1.5-.5 1.5-.5Z"/>',
    "zip":   '<rect x="2.4" y="2.4" width="11.2" height="3" rx="1"/>'
             '<path d="M3.4 5.4v7.2a1 1 0 0 0 1 1h7.2a1 1 0 0 0 1-1V5.4"/><path d="M6.6 8.6h2.8"/>',
    "activity": '<path d="M1.5 8.5h3l2.2-5.5 3 10.5 2-6.5h2.8"/>',
    "git":      '<circle cx="8" cy="8" r="2.8"/><path d="M1.5 8h3.7M10.8 8h3.7"/>',
    "diff":     '<path d="M5.5 4h5M5.5 8h5M5.5 12h5M2.5 4v8"/>',
    "term":     '<path d="m3 5 4 3-4 3M8 11h5"/>',
    # 品牌 logo「Mikata 守护之眼纹」: 圆纹章圈=守护结界, 杏仁眼=見方(注视),
    # 实心瞳=味方(在场的同伴) — 唯一重音。眼宽 7.6/纹径 13 ≈ 58%, 瞳 r1.4 ≈ 11%。
    "mikata": '<circle cx="8" cy="8" r="6.5"/>'
              '<path d="M4.2 8C6.2 5.6 9.8 5.6 11.8 8M4.2 8C6.2 10.4 9.8 10.4 11.8 8"/>'
