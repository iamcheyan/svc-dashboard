...
L10N = {
    "zh": {
        ...
        "tr_commit": "提交", "tr_warn": "干预", "tr_good": "恢复", "tr_done": "完成",
        "tr_idle": "无活动", "tr_empty": "暂无轨迹事件", "tr_days": "近14天",
        "trk_commit": "提交", "trk_recover": "恢复", "trk_restart": "重启", "trk_nudge": "干预",
    ...
    "en": {
        ...
        "tr_commit": "commits", "tr_warn": "interventions", "tr_good": "recoveries", "tr_done": "completed",
        "tr_idle": "no activity", "tr_empty": "No trajectory events", "tr_days": "last 14 days",
        "trk_commit": "commit", "trk_recover": "recover", "trk_restart": "restart", "trk_nudge": "nudge",
    ...
    "ja": {
        ...
        "tr_commit": "コミット", "tr_warn": "介入", "tr_good": "復帰", "tr_done": "完了",
        "tr_idle": "活動なし", "tr_empty": "軌跡イベントなし", "tr_days": "直近14日",
        "trk_commit": "コミット", "trk_recover": "復帰", "trk_restart": "再起動", "trk_nudge": "介入",
